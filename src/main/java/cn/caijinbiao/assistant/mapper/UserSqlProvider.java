...
import cn.caijinbiao.assistant.model.UserExample.Criteria;
import cn.caijinbiao.assistant.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getOpenId() != null) {
            sql.VALUES("f_open_id", "#{openId,jdbcType=VARCHAR}");
        }
